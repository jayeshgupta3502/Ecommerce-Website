            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg">
					 <a class="navbar-brand" href="index.php">SAI GENERAL STORE</a>
...
<div>
    <img src="myupi.jpg" style="height:400px;max-width:95%;border:6px double #545565;">
</div>
        <!-- </div> -->
        <!-- <div class="container">
        <div class="jumbotron">
...
<h4 class="container"> Thank you for Ordering at SAI GENERAL STORE'! After Confirmation from our side we will contact you from email  or call between 24-48 hrs.</h4>
