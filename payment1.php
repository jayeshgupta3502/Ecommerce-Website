...
<div class="container">
  ...
  <a href="payment.php"><span class="btn btn-success">Credit/Debit card</span></a>
    <a href="cod.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> Cash On Delivery</button></a>
    <a href="upi.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> UPI</button></a>
</div>
